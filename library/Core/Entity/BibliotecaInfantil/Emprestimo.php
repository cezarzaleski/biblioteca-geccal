...
class Emprestimo
{
     ...
     * @var Livro
     *
     * @ORM\ManyToOne(targetEntity="Livro",inversedBy="idLivroEmprestimo")
     * @ORM\JoinColumns({
     ...
     * @return Emprestimo
     */
    public function setIdEvangelizandoTurma(\Core\Entity\BibliotecaInfantil\EvangelizandoTurma $idEvangelizandoTurma = null)
    {
