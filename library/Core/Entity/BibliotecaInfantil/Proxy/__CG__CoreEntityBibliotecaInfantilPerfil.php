 ...
 */
class Perfil extends \Core\Entity\BibliotecaInfantil\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdPerfil()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idPerfil"];
        }
        $this->__load();
    ...
    {
        $this->__load();
        return parent::setNoPerfil($noPerfil);
    }

    public function getNoPerfil()
    {
        $this->__load();
        return parent::getNoPerfil();
    }
    ...
    {
        $this->__load();
        return parent::addFuncionalidade($idFuncionalidade);
    }

    public function getIdFuncionalidade()
    {
        $this->__load();
        return parent::getIdFuncionalidade();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'idPerfil', 'noPerfil', 'stAtivo', 'idFuncionalidade');
    }
