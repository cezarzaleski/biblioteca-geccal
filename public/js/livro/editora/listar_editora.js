$(function(){
    ...
    $('tbody tr.pointer').click(function() {
        ...
        if(option){
            location.href="/livro/editora/editar/id/"+id;
        }
    });
                ...
                if(code.length > 0){
                    $.ajax({
                        ...
                        success: function(data, textStatus){
                            ...
                            if(confirm === "true"){
                                new Messi('Editora(s) excluída(s) com sucesso!', {
                                    title: 'SUCESSO'
                                });
                                ...
                                new Messi('Não foi possível excluir editora, por favor entre em contato com o administrador.', {
                                    title: 'ERRO'
                                });
                            }
                        },
