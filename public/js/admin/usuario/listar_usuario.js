$(function(){
    ...
    $('tbody tr.pointer').click(function() {
        ...
        if(option){
            location.href="/admin/usuario/editar/id/"+id;
        }
    });
                ...
                if(code.length > 0){
                    $.ajax({
                        ...
                        success: function(data, textStatus){
                            ...
                            if(confirm == "true"){
                                new Messi('Usuário(s) excluído(s) com sucesso!', {
                                    title: 'SUCESSO'
                                });
                                ...
                                new Messi('Não foi possível excluir usuário(s), por favor entre em contato com o administrador.', {
                                    title: 'ERRO'
                                });
                            }
                        },
